...
module.exports = {
	category: 'moderation',
	usage: "auditlogs [generate/check/manage]",
	structure: new SlashCommandBuilder()
		.setName("auditlogs")
		.setDescription(
			"Creates an audit logs category with all necessary logs"
		)
		...
		.addSubcommand((option) =>
			option
				.setName("generate")
				.setDescription(
					"Generates the category and channels + the webhooks for audit logs"
				)
		)
		.addSubcommand((option) =>
			option
				.setName("check")
				.setDescription(
					"Checks if all logs are working and fixes the broken ones"
				)
		)
		.addSubcommand((option) =>
			option
				.setName("manage")
				.setDescription("Turn on/off some of the logs or all of them")
		),
	/**
